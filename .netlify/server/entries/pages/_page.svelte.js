...
const css$2 = {
  code: '.lightbox-container.svelte-10fb3lo.svelte-10fb3lo{position:fixed;top:0;left:0;width:100%;height:100vh;height:100dvh;isolation:isolate;z-index:99999;border:none;padding:0;margin:0;background-color:rgba(0, 0, 0, 0.9);opacity:0;transition:opacity 300ms;backface-visibility:hidden;-webkit-backface-visibility:hidden}.lightbox-container.svelte-10fb3lo.svelte-10fb3lo::backdrop{all:revert}.lightbox.svelte-10fb3lo.svelte-10fb3lo{font-family:"Source Serif Pro";color:hsl(176, 59%, 90%);position:relative;z-index:10;display:grid;place-items:center;height:100%;font-size:0.75rem}.lightbox.svelte-10fb3lo svg.svelte-10fb3lo{display:block}.lightbox_controls.svelte-10fb3lo.svelte-10fb3lo{position:absolute;cursor:pointer;mix-blend-mode:exclusion}.lightbox_controls.svelte-10fb3lo.svelte-10fb3lo:focus-visible{outline:1px solid hsl(176, 59%, 90%)}.lightbox_previous-image-button.svelte-10fb3lo.svelte-10fb3lo{left:1em;top:50%;transform:translateY(-50%)}.lightbox_next-image-button.svelte-10fb3lo.svelte-10fb3lo{top:50%;right:1em;transform:translateY(-50%)}.lightbox_close-button.svelte-10fb3lo.svelte-10fb3lo{top:0;right:0;margin-right:1em;margin-top:1em}.close-icon.svelte-10fb3lo.svelte-10fb3lo{width:2em}.chevron-icon.svelte-10fb3lo.svelte-10fb3lo{width:2em}.lightboxOpen.svelte-10fb3lo.svelte-10fb3lo{opacity:1}',
  map: null
};
const Lightbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<dialog class="${["lightbox-container svelte-10fb3lo", $isVisible === true ? "lightboxOpen" : ""].join(" ").trim()}"${add_attribute("this", dialog, 0)}><div class="lightbox svelte-10fb3lo">${validate_component(LightboxFigure, "LightboxFigure").$$render($$result, Object.assign({}, $galleryItems[$currentItemIndex]), {}, {})}
		<button class="lightbox_previous-image-button lightbox_controls svelte-10fb3lo"><svg class="chevron-icon svelte-10fb3lo" width="100%" height="100%" viewBox="0 0 33 63" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" stroke-width="2"><line x1="32" y1="62" x2="1" y2="32"></line><line x1="1" y1="32" x2="32" y2="1"></line></svg></button>
		<button class="lightbox_next-image-button lightbox_controls svelte-10fb3lo"><svg class="chevron-icon svelte-10fb3lo" width="100%" height="100%" viewBox="0 0 33 63" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" stroke-width="2"><line x1="1" y1="62" x2="32" y2="32"></line><line x1="32" y1="32" x2="1" y2="1"></line></svg></button>
		<form method="dialog"><button class="lightbox_close-button lightbox_controls svelte-10fb3lo"><svg class="close-icon svelte-10fb3lo" width="100%" height="100%" viewBox="0 0 63 63" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" stroke-width="2"><line x1="1" y1="1" x2="62" y2="62"></line><line x1="62" y1="1" x2="1" y2="62"></line></svg></button></form></div>
</dialog>`;
});

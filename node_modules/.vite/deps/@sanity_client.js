...
function observable() {
  ...
  const Observable2 = opts.implementation || global$1.Observable;
  if (!Observable2) {
...
var sharedRetry = (opts) => {
  ...
  return {
    onError: (err, context2) => {
      ...
      if (!shouldRetry(err, attemptNumber, options) || attemptNumber >= max2) {
        return err;
      }
...
function defineHttpRequest(envMiddleware2) {
  const request = getIt([...envMiddleware2, printWarnings, jsonRequest(), jsonResponse(), progress(), httpError, observable({
...
function _listen(query, params) {
  ...
  return new Observable((observer) => {
    ...
    async function getEventSource() {
      const {
        default: EventSource
      } = await import("./browser-IMMZUWPH.js");
